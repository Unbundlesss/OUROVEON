...
namespace ImGui
{
    ...
    // OUROVEON
    IMGUI_API void          ColumnSeparator();
    IMGUI_API ImVec2        MeasureSpace( const ImVec2& size );
...
enum ImGuiTableFlags_
{
    ...
    ImGuiTableFlags_AdditionalOffset                = 1 << 27   // OUROVEON
};
...
enum ImGuiSliderFlags_
{
    ...
    ImGuiSliderFlags_NoLabel                = 1 << 8,       // OUROVEON
